...
return (
<div className="min-h-screen bg-gradient from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
    <Header />
    <main className="p-8">
            ...
            <Card className="bg-primary text-primary-foreground border-0">
                ...
                <CardContent>
                    <ol className="list-decimal list-inside space-y-2 text-sm">
                        <li>Start by creating recipes for your menu items with ingredient configurations</li>
                        <li>Upload your sales data in CSV or Excel format</li>
